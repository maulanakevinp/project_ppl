        ...
        <div class="col-lg-6">
            ...
            <div class="card shadow h-100">
                <div class="card-header">
                    ...
                    <a href="" class="btn btn-success btn-sm float-right addMenu" data-toggle="modal" data-target="#newMenuModal">{{ __('Add New Menu') }}</a>
                </div>
                <div class="card-body">
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('menu.store') }}" method="post" id="postMenu">
                ...
                <div class="modal-footer">
                    ...
                    <button type="Submit" class="btn btn-success" id="submitMenu">Add </button>
                </div>
            </form>
        </div>
    </div>

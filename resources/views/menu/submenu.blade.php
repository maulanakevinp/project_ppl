        ...
        <div class="col-lg">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    ...
                    <a href="" class="btn btn-sm btn-success float-right addSubMenu" data-toggle="modal" data-target="#newSubMenuModal">{{ __('Add New Submenu') }}</a>
                </div>
                <div class="card-body">
            ...
            <form id="postSubMenu" action="{{ route('submenu.store') }}" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="Submit" class="btn btn-success" id="submitSubMenu">Add </button>
                    </div>
                </div>
            </form>
        </div>

@extends('layouts.app')
@section('title')
{{ __('submenu.submenu_management') }} - {{ config('app.name') }}
@endsection
@section('content')
        ...
        <div class="col-lg">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h5 class="m-0 pt-1 font-weight-bold text-dark float-left">{{ __('submenu.submenu_management') }}</h5>
                    <a href="" class="btn btn-sm btn-success float-right addSubMenu" data-toggle="modal" data-target="#newSubMenuModal">{{ __('submenu.add') }}</a>
                    <!-- Modal -->
                                ...
                                <form action="{{ route('submenu.store') }}" method="post">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="Submit" class="btn btn-success" id="submitSubMenu">@lang('submenu.add') </button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                        ...
                        <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="" data-toggle="modal" data-target="{{'#editSubMenuModal'.$i}}" ><span class="badge badge-success">{{ __('submenu.edit') }}</span></a>
                                        <!-- Modal -->
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{ route('submenu.update',$submenu->id) }}" method="post">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">@lang('submenu.close')</button>
                                                                <button type="Submit" class="btn btn-success" id="submitSubMenu">@lang('submenu.edit') </button>
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
